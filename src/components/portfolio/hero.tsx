...
export function Hero({ content }: { content: SiteContent }) {
  return (
    <section className="relative min-h-[70vh] flex flex-col items-center justify-center pt-12 pb-24 px-4 overflow-hidden">
      ...
      >
        <h1 className="font-headline text-5xl md:text-7xl lg:text-8xl font-bold mb-8 tracking-tighter leading-none">
          Architecting<br />
          <span className="text-primary">Autonomous AI Systems</span>
        </h1>
